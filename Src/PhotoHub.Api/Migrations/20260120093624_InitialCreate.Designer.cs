...
namespace PhotoHub.Api.Migrations
{
    ...
    [Migration("20260120093624_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoHub.API.Shared.Models.AssetUserTag", b =>
                {
                    b.Property<Guid>("AssetId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PhotoHub.API.Shared.Models.UserTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PhotoHub.API.Shared.Models.AssetExif", b =>
                {
                    b.HasOne("PhotoHub.API.Shared.Models.Asset", "Asset")
                        .WithOne("Exif")
                        .HasForeignKey("PhotoHub.API.Shared.Models.AssetExif", "AssetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PhotoHub.API.Shared.Models.AssetUserTag", b =>
                {
                    ...
                    b.HasOne("PhotoHub.API.Shared.Models.UserTag", "UserTag")
                        .WithMany("AssetLinks")
